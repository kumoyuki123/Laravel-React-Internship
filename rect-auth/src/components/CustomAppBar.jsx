...
const settings = ["プロファイル", "テーマ", "ログアウト"];
    ...
    children: [
      {
        text: "大学一覧",
        icon: <ChecklistIcon />,
        path: "/dashboard/schoolList",
      },
      {
        text: "大学作成",
        icon: <ApartmentIcon />,
        path: "/dashboard/schoolCreate",
      },
    ],
  },
  {
    ...
    children: [
      {
        text: "出席者一覧",
        icon: <ChecklistIcon />,
        path: "/dashboard/attendenceList",
      },
      {
        text: "出席者作成",
        icon: <NoteAddIcon />,
        path: "/dashboard/attendenceCreate",
      },
    ],
  },
];
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        ...
        sx={{
          background:
            "linear-gradient(to right, rgba(92,155,16,1) 19%, rgba(97,253,102,1) 81%)",
        }}
      >
      ...
      <Drawer variant="permanent" open={open}>
        ...
        >
          <Typography sx={{ fontWeight: 900, fontSize: 20, paddingLeft: 8 }}>
            管理設定
          </Typography>
        ...
        <List sx={{ padding: 0 }}>
          {navItems.map((item) => (
            <React.Fragment key={item.text}>
              ...
              <Collapse
                in={expandedSection === item.text && open}
                timeout="auto"
                unmountOnExit
              >
